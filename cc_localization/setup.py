...
setup(
    ...
    description='ArUco-based localization of nested coordinate frames for the construction cell, intended to publish tf transforms for an outer world frame and an inner workspace frame.',
    license='Apache-2.0',
    extras_require={
        'test': [
            'pytest',
