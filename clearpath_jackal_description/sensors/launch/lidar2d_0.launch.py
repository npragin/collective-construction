            ...
            [
                {
                    'use_sim_time': True
                    ,
                    'config_file': '/home/jn2-alt/college/2025-2026/spring/ROB599_multi_robot/collective-construction/clearpath_jackal_description/sensors/config/lidar2d_0.yaml'
                    ,
                }
                ,
            ]
    ...
    node_lidar2d_0_static_tf = Node(
        ...
        arguments=
            [
                ...
                '--child-frame-id'
                ,
                'j100_0897/robot/base_link/lidar2d_0'
                ,
            ]
        ,
        remappings=
