        ...
        launch_arguments=
            [
                (
                    'parameters'
                    ,
                    '/home/jn2-alt/college/2025-2026/spring/ROB599_multi_robot/collective-construction/clearpath_jackal_description/sensors/config/lidar2d_0.yaml'
                )
                ,
                (
                    'namespace'
                    ,
                    'j100_0897/sensors/lidar2d_0'
                )
                ,
                (
                    'robot_namespace'
