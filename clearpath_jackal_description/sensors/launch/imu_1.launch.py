            ...
            [
                {
                    'use_sim_time': True
                    ,
                    'config_file': '/home/jn2-alt/college/2025-2026/spring/ROB599_multi_robot/collective-construction/clearpath_jackal_description/sensors/config/imu_1.yaml'
                    ,
                }
                ,
            ]
    ...
    node_imu_1_static_tf = Node(
        ...
        arguments=
            [
                ...
                '--child-frame-id'
                ,
                'j100_0897/robot/base_link/imu_1'
                ,
            ]
        ,
        remappings=
